...
*Starts with the position ofthe first byte in hexadecimal (8 chars),
*starting with '0'
*Each line shows the hexadecimal content (2 chars) of the buffer,
*2 bytes at a time, separated by space.
*Each line shows the content of the buffer.
*Prints the byte if it is printable; if not, prints'.'.
*Each line ends with a new line '\n'.
*if the inputter byte size is 0 or less,the function only prints a new line.
*@b: number of bytes
